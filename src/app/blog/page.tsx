        ...
        <div className="my-40  w-3/4 mx-auto">
          ...
          <div className={`${Style.blog}`}>
            ...
            <div>
              ...
              <section className="relative py-12 sm:py-16 lg:py-20 bg-black my-16">
                <div className="absolute inset-0">
                  <img
                  ...
                  <div className="grid grid-cols-1 gap-y-12 lg:grid-cols-2 gap-x-16">
                    <div>
                      ...
                      <p className="mt-8 font-sans text-lg text-opacity-50 text-white">
                        Vulputate nunc purus, porttitor ornare diam aliquam.
                        Gravida fringilla non morbi commodo ut lectus. Venenatis
                        nunc mauris viverra posuere. Morbi pulvinar lectus
                        dignissim et vitae mattis ac.
                      </p>
