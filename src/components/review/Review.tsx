...
const Review = () => {
  return (
    <section className="py-12 border sm:py-16 lg:py-20">
                ...
                <div className="md:col-span-5">
                  ...
                  <blockquote className="mt-4">
                    <p className="text-sm font-normal leading-6 ">
                      Almost completed building my replacement website and very
                      pleased with the result. Although the customization is
                      great the theme's features and Customer Support have also
                      been great..
                    </p>
                  </blockquote>
                </div>
                ...
                <div className="md:col-span-5">
                  ...
                  <blockquote className="mt-4">
                    <p className="text-sm font-normal leading-6 ">
                      ...
                      quickness of page loads you can really appreciate once you
                      turn off page transition preloader in theme options.
                      <br />
                      <br />
                      Custom support was really quick to respond to all my
                      questions and resolve all my issue, very satisfied with
                      this theme, VERY good value for money.
                    </p>
                  </blockquote>
                </div>
              </li>
                ...
                <div className="md:col-span-5">
                  ...
                  <blockquote className="mt-4">
                    <p className="text-sm font-normal leading-6 ">
                      ...
                      business that wants to showcase it's products or services.
                      Great work!
                    </p>
                  </blockquote>
                </div>
