    ...
    <section className="py-12 sm:py-16 lg:py-20 border">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-4 mt-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 sm:mt-10">
          <div className="relative overflow-hidden bg-slate-800 border border-gray-200 rounded-xl group">
          ...
          <div className="relative overflow-hidden bg-slate-800 border border-gray-200 rounded-xl group">
            ...
            <div className="absolute inset-x-0 bottom-0 transition-all duration-200 translate-y-full group-hover:translate-y-0">
              <button
                type="button"
                className="flex items-center justify-center w-full px-4 py-2.5 text-sm font-bold bg-gray-900 text-white transition-all duration-200 "
              >
                <svg
                  className="w-5 h-5 mr-2"
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="relative overflow-hidden bg-slate-800 border border-gray-200 rounded-xl group">
            ...
            <div className="absolute inset-x-0 bottom-0 transition-all duration-200 translate-y-full group-hover:translate-y-0">
              <button
                type="button"
                className="flex items-center justify-center w-full px-4 py-2.5 text-sm font-bold text-white transition-all bg-gray-900 duration-200"
              >
                <svg
                  className="w-5 h-5 mr-2"
                  xmlns="http://www.w3.org/2000/svg"
