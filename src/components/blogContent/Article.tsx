    ...
    <div className="flex flex-col border">
      <section className="py-12 sm:py-16 lg:py-20">
        <div className="px-4 mx-auto w-full sm:px-6 lg:px-8">
          <p className="text-sm font-normal  font-pj">Nov 19, 2021</p>
      ...
      <section className="py-12  sm:py-16 lg:py-20">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="w-full mx-auto xl:max-w-5xl">
            ...
            <p className="text-sm font-normal  mt-7 font-pj">April 14, 2021</p>
