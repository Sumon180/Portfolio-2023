...
const Article2 = () => {
  return (
    <div className="flex mt-20 flex-col border">
        ...
        <div className="grid grid-cols-1 mt-10 lg:grid-cols-12 lg:mt-24 gap-y-10 lg:gap-x-20">
          <div className="lg:col-span-5">
            <div className="overflow-hidden rounded-2xl lg:h-full max-h-96 lg:max-h-full">
              <img
                ...
                src="https://cdn.rareblocks.xyz/collection/clarity/images/long-form/2/img-blog.png"
                alt=""
              />
            </div>
            {/* <div className="w-full h-full overflow-hidden rounded-2xl aspect-w-3 aspect-h-4 sm:aspect-h-3 lg:aspect-none">
              <img
                className="object-cover w-full h-full lg:w-auto"
                src="https://cdn.rareblocks.xyz/collection/clarity/images/long-form/2/img-blog.png"
                alt=""
              />
            </div> */}
          ...
          <div className="lg:col-span-7">
            <p className="text-base font-normal leading-7 text-gray-300 font-pj">
              ...
              posuere vestibulum lectus id eu sollicitudin. Tellus amet bibendum
              sit mus phasellus quis duis lacus. Enim eget sagittis, auctor
              iaculis nulla semper. In vitae neque integer integer metus, est,
              tristique fermentum tristique.
            </p>

            <h2 className="mt-10 text-2xl  font-pj font-bodl">
            ...
            <p className="mt-6 text-base font-normal leading-7 text-gray-300 font-pj">
              Tellus amet bibendum sit mus phasellus quis duis lacus. Enim eget
              sagittis, auctor iaculis nulla semper. In vitae neque integer
              integer metus, est, tristique fermentum tristique.
            </p>
          </div>
        </div>
      </div>
    ...
    <section className="py-12  sm:py-16 lg:py-20">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto xl:max-w-4xl">
          ...
          <div className="mt-10">
            <p className="text-base font-normal leading-7  font-pj">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Massa
              risus sed eget ornare posuere turpis vitae. Id elementum velit
              posuere vestibulum lectus id eu sollicitudin. Tellus amet bibendum
              sit mus phasellus quis duis lacus. Enim eget sagittis, auctor
            ...
            <blockquote className="pl-5 mt-8 border-l-2 border-gray-500">
              <p className="text-lg italic font-medium  font-pj">
